...
{
    [Kingdee.BOS.Util.HotUpdate, Description("生产补料推送至OA")]
    public class FeedMtrlPush : AbstractOperationServicePlugIn
    {
        ...
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            foreach (DynamicObject item in e.DataEntitys)
            {
                ...
                string SF_SRT_ProjectName = F_SRT_Project == null ? "" : Convert.ToString(F_SRT_Project["Name"]);
                ...
                mainRootItem.Add("fieldValue", SF_SRT_ProjectName);
                mainRoot.Add(mainRootItem);
                ...
                detailDataItem.Add("tableDBName", "formtable_main_70_dt1");
                ...
                foreach (DynamicObject material in materials)
                {
                    ...
                    string ScrapQty = Convert.ToDecimal(material["ScrapQty"]).ToString("#0.00");
                    ...
                    DynamicObject FeedReasonId = material["FeedReasonId"] as DynamicObject;
                    string FeedReasonIdName = FeedReasonId == null ? "" : Convert.ToString(FeedReasonId["FDataValue"]);
                    string MoBillNo = Convert.ToString(material["MoBillNo"]);
                    DynamicObject EntryWorkShopId = material["WorkShopId"] as DynamicObject;
                    string EntryWorkShopIdName = EntryWorkShopId == null ? "" : Convert.ToString(EntryWorkShopId["Name"]);
                    ...
                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "bfsl");
                    workflowRequestTableFieldsItem.Add("fieldValue", ScrapQty);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "blyy");
                    workflowRequestTableFieldsItem.Add("fieldValue", FeedReasonIdName);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    string resultStr = Utils.wkPostUrl(Utils.pushAddWF,
                        ...
                        + "&requestName=生产补料单已到达"
                        + "&workflowId=26&detailData=" + detailData.ToString(), personId);
