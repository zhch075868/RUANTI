...
{
    [Kingdee.BOS.Util.HotUpdate, Description("生产领料推送至OA")]
    public class PickMtrlPush : AbstractOperationServicePlugIn
    {
        ...
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            foreach (DynamicObject item in e.DataEntitys)
            {
                ...
                DynamicObject PickerId = o["PickerId"] as DynamicObject;
                string PickerIdName = PickerId == null ? "" : Convert.ToString(PickerId["Number"]);
                PickerIdName = Utils.getPersonOAid(this.Context, PickerIdName);
                ...
                //mainRootItem = new JSONObject();
                //mainRootItem.Add("fieldName", "flzz");
                ...
                mainRootItem = new JSONObject();
                mainRootItem.Add("fieldName", "llr");
                mainRootItem.Add("fieldValue", PickerIdName);
                mainRoot.Add(mainRootItem);
                ...
                detailDataItem.Add("tableDBName", "formtable_main_69_dt1");
                ...
                foreach (DynamicObject material in materials)
                {
                    ...
                    string ActualQty = Convert.ToDecimal(material["ActualQty"]).ToString("#0.00");
                    ...
                    var field = this.BusinessInfo.GetField("FSrcBusinessType") as ComboField; ;
                    var enumValue = material["SrcBusinessType"];
                    var SrcBusinessType = field.GetEnumItemName(enumValue);
                    string InventoryQty = Convert.ToDecimal(material["InventoryQty"]).ToString("#0.00");
                    string TransRetFormId = Convert.ToString(material["TransRetFormId"]);
                    string TransRetBillNo = Convert.ToString(material["TransRetBillNo"]);
                    string TransRetEntryId = Convert.ToString(material["TransRetEntryId"]);
                    string TransRetEntrySeq = Convert.ToString(material["TransRetEntrySeq"]);
                    ...
                    DynamicObject entryWorkShopId = material["WorkShopId"] as DynamicObject;
                    string entryWorkShopIdName = WorkShopId == null ? "" : Convert.ToString(WorkShopId["Name"]);
                    ...
                    workflowRequestTableFieldsItem.Add("fieldValue", ActualQty);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "ywlylx");
                    workflowRequestTableFieldsItem.Add("fieldValue", SrcBusinessType);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);

                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "kykc");
                    workflowRequestTableFieldsItem.Add("fieldValue", InventoryQty);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);

                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "zctldbs");
                    workflowRequestTableFieldsItem.Add("fieldValue", TransRetFormId);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);

                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "zctldh");
                    workflowRequestTableFieldsItem.Add("fieldValue", TransRetBillNo);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);

                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "zctldnm");
                    workflowRequestTableFieldsItem.Add("fieldValue", TransRetEntryId);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);

                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "zctldxh");
                    workflowRequestTableFieldsItem.Add("fieldValue", TransRetEntrySeq);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    workflowRequestTableFieldsItem.Add("fieldValue", entryWorkShopIdName);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    string resultStr = Utils.wkPostUrl(Utils.pushAddWF,
                        ...
                        + "&requestName=生产领料单已到达"
                        + "&workflowId=25&detailData=" + detailData.ToString(), personId);
