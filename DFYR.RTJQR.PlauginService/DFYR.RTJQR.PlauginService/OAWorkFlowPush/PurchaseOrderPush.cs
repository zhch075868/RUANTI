...
{
    [Kingdee.BOS.Util.HotUpdate, Description("采购订单推送")]
    public class PurchaseOrderPush : AbstractOperationServicePlugIn
    {
        ...
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            foreach (DynamicObject o in e.DataEntitys)
            {
                ...
                string F_SRT_CGLX =F_SRT_CGLXId == null?"": Convert.ToString(F_SRT_CGLXId["Number"]);
                ...
                string billTypeIdX =billTypeId == null?"": Convert.ToString(billTypeId["Number"]);
                ...
                //var enumValue = o["F_SRT_CONTRACTYPE"];
                //var contractTypeName = field.GetEnumItemName(enumValue);
                ...
                string FPost = providerContactId == null ? "" : Convert.ToString(providerContactId["FPost"]);
                string FMobile = providerContactId == null ? "" : Convert.ToString(providerContactId["Mobile"]);
                ...
                PurchaserNumber = queryBuyerEntryIdByNumber(PurchaserNumber);
                ...
                string oaContractType = this.contractType(erpContractType);
                string contractBeginDate = Convert.ToDateTime(o["F_PYEO_BeginDate"]).ToString("yyyy-MM-dd");
                string contractEndDate = Convert.ToDateTime(o["F_PYEO_EndDate"]).ToString("yyyy-MM-dd");
                ...
                mainRootItem = new JSONObject();
                mainRootItem.Add("fieldName", "erpid");
                mainRootItem.Add("fieldValue", id);
                mainRoot.Add(mainRootItem);
                

                mainRootItem = new JSONObject();
                mainRootItem.Add("fieldName", "sfglkjht");
                mainRootItem.Add("fieldValue", F_SRT_CheckBox);
                mainRoot.Add(mainRootItem);
                ...
                //mainRootItem.Add("fieldValue", oaContractType);
                //mainRoot.Add(mainRootItem);
                ...
                mainRootItem.Add("fieldValue", IsIncludedTax.Equals("True") ? "0" : "1");
                mainRoot.Add(mainRootItem);

                mainRootItem = new JSONObject();
                mainRootItem.Add("fieldName", "jws");
                mainRootItem.Add("fieldValue", FISPRICEEXCLUDETAX.Equals("True") ? "0" : "1");
                mainRoot.Add(mainRootItem);
                ...
                mainRootItem.Add("fieldValue", F_SRT_ChrckMode.Equals("True") ? "0" : "1");
                mainRoot.Add(mainRootItem);
                ...
                mainRootItem = new JSONObject();
                mainRootItem.Add("fieldName", "glkjhth");
                mainRootItem.Add("fieldValue", F_SRT_LSHTH2Number);
                mainRoot.Add(mainRootItem);
                ...
                mainRootItem = new JSONObject();
                mainRootItem.Add("fieldName", "ksrq");
                mainRootItem.Add("fieldValue", contractBeginDate);
                mainRoot.Add(mainRootItem);

                mainRootItem = new JSONObject();
                mainRootItem.Add("fieldName", "jsrq");
                mainRootItem.Add("fieldValue", contractEndDate);
                mainRoot.Add(mainRootItem);

                JSONArray detailData = new JSONArray();

                JSONObject detailDataItem = new JSONObject();
                detailDataItem.Add("tableDBName", "formtable_main_52_dt1");
                ...
                foreach (DynamicObject entry in POOrderEntrys)
                {
                    ...
                    DynamicObject F_PYEO_YFSCZXM = entry["F_PYEO_YFSCZXM"] as DynamicObject;
                    string F_PYEO_YFSCZXMName = F_PYEO_YFSCZXM == null ? "" : Convert.ToString(F_PYEO_YFSCZXM["Name"]);
                    ...
                    workflowRequestTableFieldsItem.Add("fieldName", "yfsczxm");
                    workflowRequestTableFieldsItem.Add("fieldValue", F_PYEO_YFSCZXMName);
                    ...
                    workflowRequestTableFieldsItem.Add("fieldValue", DeliveryControl.Equals("True") ? "0" : "1");
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    workflowRequestTableFieldsItem.Add("fieldValue", TimeControl.Equals("True") ? "0" : "1");
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    workflowRequestTableFieldsItem.Add("fieldValue", GiveAway.Equals("True") ? "0" : "1");
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                    ...
                    workflowRequestTableFieldsItem = new JSONObject();
                    workflowRequestTableFieldsItem.Add("fieldName", "erpfkjhid");
                    workflowRequestTableFieldsItem.Add("fieldValue", entryId);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                ...
                detailDataItem.Add("tableDBName", "formtable_main_52_dt2");
                ...
                foreach (DynamicObject IinstallmentItem in FIinstallment)
                {
                    ...
                    workflowRequestTableFieldsItem.Add("fieldValue", F_SRT_SFFK1);
                    workflowRequestTableFields.Add(workflowRequestTableFieldsItem);
                ...
                string resultStr = Utils.wkPostUrl(Utils.pushAddWF,
                                     ...
                                     + "&requestName=采购订单已到达"
                                     + "&workflowId=11&detailData=" + detailData.ToString(), personId);
        ...
        private string getOABillType(string erpId)
        {
            try
            {
                string queryOAidSql = string.Format(@"select F_PYEO_OAID from PYEO_t_Cust_Entry100024 where F_PYEO_ERPID = '{0}'", erpId);
        ...
        /// 查询业务员id
        /// </summary>
        private string queryBuyerEntryIdByNumber(string number)
        {
            try
            {
                string sql = string.Format("select FENTRYID from T_BD_OPERATORENTRY where FOPERATORTYPE = 'CGY' AND FNUMBER = '{0}'", number);
                return DBUtils.ExecuteDynamicObject(this.Context, sql)[0]["FENTRYID"].ToString();
            }
            catch (Exception e)
            {
                return "";
