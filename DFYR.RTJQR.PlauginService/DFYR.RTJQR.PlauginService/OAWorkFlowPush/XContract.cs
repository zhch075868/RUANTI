...
{
    [Kingdee.BOS.Util.HotUpdate, Description("销售合同变更单推送至OA")]
    public class XContract : AbstractOperationServicePlugIn
    {
        ...
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            foreach (DynamicObject o in e.DataEntitys)
            {
                ...
                detailDataItem.Add("tableDBName", "formtable_main_59_dt1");
                ...
                detailDataItem.Add("tableDBName", "formtable_main_59_dt2");
                ...
                string resultStr = Utils.wkPostUrl(Utils.pushAddWF,
                    ...
                    + "&requestName=销售合同已到达"
                    + "&workflowId=18&detailData=" + detailData.ToString(), personId);
