...
{
    public class SalOrderAuditToContract : AbstractOperationServicePlugIn
    {
        public override void OnPreparePropertys(PreparePropertysEventArgs e)
        {
            //e.FieldKeys.Add("");
            e.FieldKeys.Add("FName");
            e.FieldKeys.Add("F_PYEO__SRT_LSHTH2");
            e.FieldKeys.Add("F_PYEO_SRT_CheckBox");
        ...
        public override void EndOperationTransaction(EndOperationTransactionArgs e)
        {
            ...
            {
                DynamicObject contractId = o["F_PYEO__SRT_LSHTH2"] as DynamicObject;
                if (null != contractId)
                {
                    return;
                }
                string htId = ImportMaterial(o);
                string F_SRT_CheckBox = Convert.ToString(o["F_PYEO_SRT_CheckBox"]);
                ...
                string sql = string.Format("update T_CRM_CONTRACT set F_PYEO__SRT_LSHTH2 = {0} where fid = {1}", htId, BillId);
        ...
        private void FillMaterialPropertys(IBillView billView, DynamicObject o)
        {
            ...
            string contractName = Convert.ToString(o["FName"]);
            ...
            string ContractType = Convert.ToString(o["ContractType"]);
            ...
            dynamicFormView.UpdateValue("FName", 0, "销售合同");
